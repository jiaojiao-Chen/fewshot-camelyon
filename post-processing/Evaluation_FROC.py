...
if __name__ == "__main__":
    mask_folder = "/media/jiaojiao/Seagate Backup Plus Drive/CAMELYON16/TestingData/Ground_Truth/Masks"
    result_folder = "/home/jiaojiao/Desktop/test"
    result_file_list = []
    result_file_list += [each for each in os.listdir(result_folder) if each.endswith('.csv')]
    figName = "Figure.png"
    txtName = "Figure.txt"
    EVALUATION_MASK_LEVEL = 6  # Image level at which the evaluation is done  # 6 before
